...
let g:ycm_key_invoke_completion='<C-f>'  "(Ctrl+f)来快速补全
let g:ycm_key_list_select_completion=['<C-j>']  "光标向前<ctrl+j> 
let g:ycm_key_list_previous_completion=['<C-k>']  "光标向后 <ctrl+k>
...
" 按下Ctrl-F5，在当前目录递归生成tag文件
map <C-F5> :!ctags -R<CR><CR>
imap <C-F5> <ESC>:!ctags -R<CR><CR>
